...
public class Organization  implements Comparable<Organization>, OrganizationInterface{
    ...
    public Organization(long id, String name, Coordinates coordinates,  double annualTurnover, String fullName, Long employeesCount, OrganizationType type, Address officialAddress){
        this.id = id;
        this.name = name;
    ...
    public OrganizationType getOrganizationType(){
        return this.getOrganizationType();
    }
